...
from ifrs_reporting.doctype.account_category.account_category import import_account_categories
from ifrs_reporting.doctype.financial_report_template.financial_report_validation import TemplateValidator
...
class FinancialReportTemplate(Document):
	...
	if TYPE_CHECKING:
		...
		from ifrs_reporting.doctype.financial_report_row.financial_report_row import FinancialReportRow
	...
	def _export_account_categories(self):
		...
		from ifrs_reporting.doctype.financial_report_template.financial_report_engine import (
